            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  <h1  data-aos="fade-up" data-aos-delay="100">List of consultations</h1>
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200">On this page you can find currently available consultations</p>
                  <!--<p data-aos="fade-up" data-aos-delay="300"><a href="#" class="btn btn-primary py-3 px-5 btn-pill">Admission Now</a></p>-->

                </div>
                <div class="dropdown" data-aos="fade-up" data-aos-delay="200">
