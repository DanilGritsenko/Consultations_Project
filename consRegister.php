...
?>
  ...
  <?php
      ...
      $kask->bind_result($regid, $consname, $student, $teacher);
      $kask->execute();
      while($kask->fetch()){
          echo '<tr>';
          echo '<th scope=row>'.htmlspecialchars($regid).'</th>';
          echo '<td>'.htmlspecialchars($consname).'</th>';
          echo '<td>'.htmlspecialchars($student).'</th>';
          echo '<td>'.htmlspecialchars($teacher).'</th>';
          echo '</tr>';
      }
